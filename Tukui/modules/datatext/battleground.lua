...
Text1:SetFont(C["media"].dfont, C["datatext"].fsize, "OUTLINE")
...
Text2:SetFont(C["media"].dfont, C["datatext"].fsize, "OUTLINE")
...
Text3:SetFont(C["media"].dfont, C["datatext"].fsize, "OUTLINE")
	...
	if int < 0 then
		...
		for i=1, numScores do
			...
			if healingDone > damageDone then
				dmgtxt = (T.cStart..L.datatext_healing.."|r"..healingDone)
			else
				dmgtxt = (T.cStart..L.datatext_damage.."|r"..damageDone)
			end
			if ( name ) then
				if ( name == T.myname ) then
					Text2:SetText(T.cStart..L.datatext_honor.."|r"..format('%d', honorGained))
					Text1:SetText(dmgtxt)
					Text3:SetText(T.cStart..L.datatext_killingblows.."|r"..killingBlows)
				end   
			end
		end 
		int  = 2
