...
local font, fonts, fontf = C["media"].font, 22, "OUTLINE"
...
local SmallerMapSkin = function()
	...
	WorldMapFrameTitle:SetFont(font, fonts, fontf)
	...
	WorldMapQuestShowObjectivesText:SetFont(font, fonts, fontf)
	...
	WorldMapShowDigSitesText:SetFont(font, fonts, fontf)
	...
	WorldMapFrameAreaLabel:SetFont(font, fonts*3, fontf)
