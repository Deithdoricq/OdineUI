			...
			raidparty = {
				...
				args = {
					...
					healthdeficit = { -- healer layout only
						...
						disabled = function() return not IsAddOnLoaded("Tukui_Heal") end,
					},
					hidepower = { -- dps layout only
						...
						disabled = function() return not IsAddOnLoaded("Tukui_DPS") end,
					},
					emptyrp2 = {
						name = "   ",
						width = "full",
					...
					Addonskins = {
						...
						args = {
							embed = {
								...
								type = "select",
								name = "Embed Addon",
								desc = "Allows you to embed a supported addon into the right chat window.",
								values = {
									["NONE"] = "None",
									["Skada"] = "Skada",
								},						
			...
			chat = {
				...
				args = {
					...
					whispersound = {
						...
						desc = L["Toggles whether you want to play a sound when you receive whispers."],
					...
					background = {
						...
						order = 3,
						name = L["Background"],
						desc = L["Toggles whether you want to use backgrounds for chat windows."],
						disabled = function() return not db.chat.enable end,
					},
					fading = {
						type = "toggle",
						order = 4,
						name = L["Fading"],
						desc = L["Toggles whether you want to fade out chat text when not active."],
						disabled = function() return not db.chat.enable end,
					},
					justifyRight = {
						type = "toggle",
						order = 5,
						name = L["Justify Right"],
						desc = L["Toggles whether you want to justify text to the right in your right char box window."],
						disabled = function() return not db.chat.enable end,
					},
					emptyderp5 = {
						name = "   ",
					...
					height = {
						...
						order = 7,
						name = L["Height"],
						desc = L["Choose the height of chat windows."],
			...
			tooltip = {
				...
				args = {
					...
					hidebuttons = {
						type = "toggle",
						order = 3,
						name = L["Hide Actionbar Tooltips"],
						desc = L["Toggles whether you want to hide tooltips from actionbar buttons."],
						disabled = function() return not db.tooltip.enable end,
					},
					hideuf = {
						type = "toggle",
						order = 4,
						name = L["Hide Unitframe Tooltips"],
						desc = L["Toggles whether you want to hide tooltips from unitframes."],
						disabled = function() return not db.tooltip.enable end,
					},
					cursor = {
						type = "toggle",
						order = 5,
						name = L["Cursor"],
						desc = L["When enabled allows you to have tooltips display where your mouse is."],
						disabled = function() return not db.tooltip.enable end,
					},
					empty6t = {
						name = "   ",
					...
					CTGroup = {
						...
						args = {
							...
							gen_font = {
								...
								order = 7,
								name = L["General Font"],
								desc = L["Font used for classtimers."],
								values = AceGUIWidgetLSMlists.font,	
							},
							gen_size = {
								type = "range",
								order = 8,
								name = L["General Font Size"],
								desc = L["Size used for the General Font"],
								type = "range",
								min = 5, max = 18, step = 1,								
							},
							ColorGroup = {
