		...
		if (not bar) then
			...
			if (self.Mode == "ICON") then
				...
				if (bar.count) then
					...
					bar.count:SetFont(C["media"].uffont, font_size, "OUTLINE");
				...
				if (bar.time)then
					...
					bar.time:SetFont(C["media"].uffont, font_size, "OUTLINE");
				...
				if (bar.spellname)then
					...
					bar.spellname:SetFont(C["media"].uffont, font_size, "OUTLINE");
